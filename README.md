...
This repository contains examples that illustrates how to convert Word documents to images programmatically in C#. The [.NET Word library](https://www.syncfusion.com/document-sdk/net-word-library) (DocIO) converts a Word document to images with just five lines of code and also it does not require Microsoft Word application to be installed in the machine. It preserves the original appearance of the Word document in the converted image.

## Key Features

-	[Preview the Word document](https://help.syncfusion.com/document-processing/word/conversions/word-to-image/net/word-to-image#convert-the-entire-word-to-images) - Convert an entire document to images 
